...
(function($,undefined){
	...
	$.fn.extend({
		...
		function createThumbs(container,opt) {
			...
			if (opt.navigationType=="thumb" || opt.navsecond=="both" || opt.navigationType=="bullet") {
						//cap.append('<div class="tp-bullets tp-thumbs '+opt.navigationStyle+'"><div class="tp-mask"><div class="tp-thumbcontainer"></div></div></div>');
						cap.append('<div class="tp-cornerleft"></div><div class="tp-bullets tp-thumbs '+opt.navigationStyle+'"><div class="tp-mask"><div class="tp-thumbcontainer"></div></div></div><div class="tp-cornerright"></div>');
			}
		...
		function setBulPos(container,opt) {
			...
			if (opt.navigationType=="none" && opt.navigationArrows!="none") opt.navigationArrows="verticalcentered";
				...
				if (opt.navigationType=="bullet") {
							...
							bullets.css({'left':(opt.navOH) + (ldiff/2)+(opt.width/2 - fulllong/2)-10+"px", 'bottom':opt.navOV+"px"});
							cornerLeft.css({'left':(opt.navOH) + (ldiff/2)+(opt.width/2 - fulllong/2) - 40 +"px", 'bottom':opt.navOV+"px"});
							cornerRight.css({'left':(opt.navOH) + (ldiff/2)+(opt.width/2 - fulllong/2) + fulllong + 10 +"px", 'bottom':opt.navOV+"px"});
